...
SELECT UserNo,DisplayName,date_connexion FROM dbo.LoginUserHistory RIGHT JOIN TheUser ON TheUser.UserNo=idUser JOIN TheSirh ON TheSirh.Login = DisplayName
